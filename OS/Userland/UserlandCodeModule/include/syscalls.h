...
unsigned long long sys_createProcess(void * func, char * name, unsigned int argc, char * args[]);
void sys_yield();
...
int sys_kill(unsigned long long pid);
int sys_block(unsigned long long pid);
int sys_unblock(unsigned long long pid);
